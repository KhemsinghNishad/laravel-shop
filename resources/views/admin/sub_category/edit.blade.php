                                        ...
                                        <select name="category" id="category" class="form-control">
                                            @if (!empty($categories))
                                                ...
                                                @foreach ($categories as $category)
                                                    <option
                                                        {{ $sub_categories->category_id == $category->id ? 'selected' : '' }}
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"
                                            placeholder="Name" value="{{ $sub_categories->name }}">
                                        <p></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            <option {{ $sub_categories->status == 1 ? 'selected' : '' }} value="1">
                                                Active</option>
                                            <option {{ $sub_categories->status == 0 ? 'selected' : '' }} value="0">block
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="showHome" id="show_home" class="form-control">
                                            <option {{ $sub_categories->showHome == 'Yes' ? 'selected' : '' }} value="Yes">Yes
                                            </option>
                                            <option {{ $sub_categories->showHome == 'No' ? 'selected' : '' }} value="No">No
                                            </option>
                                        </select>
                                    </div>
                                </div>
