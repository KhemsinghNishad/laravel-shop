                    ...
                    <div class="col-md-4">
                        <div class="card cart-summery">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-5">
                                    <a href="{{ route('checkout.cart') }}" class="btn-dark btn btn-block w-100">Proceed to Checkout</a>
                                </div>
                            </div>
                        </div>
                ...
                @else
                    <div class="col-md-12">
                        <div class="card text-center p-4 shadow-sm">
                            <div class="card-body">
                                <h4 class="card-title text-muted">Your cart is empty</h4>
                                <p class="card-text">No products have been added to the cart.</p>
                            </div>
                        </div>
                    </div>
                @endif
