            ...
            <div class="row pb-3">
                @if ($features->isNotEmpty())
                    @foreach ($features as $feature)
                        @php
                            $productImage = $feature->product_image->first();
                        @endphp
                        <div class="col-md-3">
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    @if ($productImage)
                                        <a href="{{ route('product.shop', $feature->slug) }}" class="product-img"><img
                                                class="card-img-top"
                                                src="{{ asset('uploads/product/small/' . $productImage->image) }}"
                                                alt=""></a>
                                        <a class="whishlist" href="{{ route('wishlist.add', $feature->id) }}"><i
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link" href="">{{ $feature->title }}</a>
                                    <div class="price mt-2">
                                        <span class="h5"><strong>{{ $feature->price }}</strong></span>
                                        @if ($feature->compare_price != null)
                                            <span
                                                class="h6 text-underline"><del>{{ $feature->compare_price }}</del></span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    @foreach ($latestProducts as $latestProduct)
                        ...
                        <div class="col-md-3">
                            <div class="card product-card">
                                @if ($productImage)
                                    <div class="product-image position-relative">
                                        <a href="{{ route('product.shop', $latestProduct->slug) }}"
                                            class="product-img"><img class="card-img-top"
                                                src="{{ asset('uploads/product/small/' . $productImage->image) }}"
                                                alt=""></a>
                                        <a class="whishlist" href="{{ route('wishlist.add', $latestProduct->id) }}"><i
                                                class="far fa-heart"></i></a>
